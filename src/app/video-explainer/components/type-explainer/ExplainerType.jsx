                        ...
                        <div className="col-span-12 md:col-span-6 lg:col-span-4">
                            <div className="card rounded-[10px] bg-white shadow-2xl pt-[25px] px-[20px] pb-[35px] h-full">
                                ...
                                <div className="content">
                                    ...
                                    <p className='text-[14px] sm:text-[16px] montserrat text-[#5b5b5b] h-[125px] leading-[1.42857143] md:pr-[17px] lg:h-[125px]'>Whiteboard videos entail simulating black-line graphics on a white background while guiding viewers through the entire concept or idea.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-span-12 md:col-span-6 lg:col-span-4">
                            <div className="card rounded-[10px] bg-white shadow-2xl pt-[25px] px-[20px] pb-[35px] h-full">
                                ...
                                <div className="content">
                                    ...
                                    <p className='text-[14px] sm:text-[16px] montserrat text-[#5b5b5b] h-[125px] leading-[1.42857143] md:pr-[17px] lg:h-[125px]'>Again, motion graphics animation videos are known for being simple and engaging. It's the perfect animation style for businesses looking to show off a wide variety of goods or services.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-span-12 md:col-span-6 lg:col-span-4">
                            <div className="card rounded-[10px] bg-white shadow-2xl pt-[25px] px-[20px] pb-[35px] h-full">
                                ...
                                <div className="content">
                                    ...
                                    <p className='text-[14px] sm:text-[16px] montserrat text-[#5b5b5b] h-[125px] leading-[1.42857143] md:pr-[17px] lg:h-[125px]'>2D animation is one of the most widely used and common animation forms today. Because of its versatility, 2D animation allows for a lot of artistic freedom when it comes to adding the next stage of customization.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-span-12 md:col-span-6 lg:col-span-4">
                            <div className="card rounded-[10px] bg-white shadow-2xl pt-[25px] px-[20px] pb-[35px] h-full">
                                ...
                                <div className="content">
                                    ...
                                    <p className='text-[14px] sm:text-[16px] montserrat text-[#5b5b5b] h-[125px] leading-[1.42857143] pr-[10px] lg:h-[125px]'>Because of its high-end and high-quality finish, 3D animation has carved out a niche for itself. With a narrative focus on the action, the distinctive aesthetics of 3D animation make it easier for viewers to interact with what is being seen in the video.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-span-12 md:col-span-6 lg:col-span-4">
                            <div className="card rounded-[10px] bg-white shadow-2xl pt-[25px] px-[20px] pb-[35px] h-full">
                                ...
                                <div className="content">
                                    ...
                                    <p className='text-[14px] sm:text-[16px] montserrat text-[#5b5b5b] h-[125px] leading-[1.42857143] md:pr-[17px] lg:h-[125px]'>It is a popular tool for startups in the technology world. It's a fantastic way to explain a procedure or film a demo video.</p>
                                </div>
                            </div>
                        </div>
                        <div className="col-span-12 md:col-span-6 lg:col-span-4">
                            <div className="card rounded-[10px] bg-white shadow-2xl pt-[25px] px-[20px] pb-[35px] h-full">
                                ...
                                <div className="content">
                                    ...
                                    <p className='text-[14px] sm:text-[16px] montserrat text-[#5b5b5b] h-[125px] leading-[1.42857143] md:pr-[17px] lg:h-[125px]'>Typography animation can render a video by effectively underlining and memorably reinforcing the message with the use of clever fonts and animation.</p>
                                </div>
                            </div>
                        </div>
                    </div>
