                ...
                <div className='px-4 sm:px-8 lg:max-w-7xl mx-auto'>
                    <div className="grid grid-cols-12">
                        <div className="col-span-12 mb-[40px]">
                            <h2 className='text-[#231f20] text-center font-[700] montserrat text-[30px]'>Why Explainer Videos Are Key to Digital Branding</h2>
                            <p className='text-[#231f20] text-[18px] montserrat font-[400] py-[17px] text-center lg:w-10/12 mx-auto leading-[22px] pb-[70px]'>Simple words or symbols do not attract as many people as video animation does. If you're about to introduce a product or service, animated videos are the perfect way to make a shout out on the digital landscapes.</p>
                        </div>
                        <div className="col-span-4">
                            <div className="card">
                                <Image src={Icon1} alt='Icon 1' className='mx-auto' />
                                <h3 className='text-[#231f20] text-[30px] font-[700] pt-[20px] pb-[10px] text-center montserrat'>Brand Video</h3>
                        ...
                        <div className="col-span-4">
                            <div className="card">
                                ...
                                <h3 className='text-[#231f20] text-[30px] font-[700] pt-[20px] pb-[10px] text-center montserrat'>2D, 3D Animated Videos</h3>
                        ...
                        <div className="col-span-4">
                            <div className="card">
                                ...
                                <h3 className='text-[#231f20] text-[30px] font-[700] pt-[20px] pb-[10px] text-center montserrat'>Commercial Videos</h3>
