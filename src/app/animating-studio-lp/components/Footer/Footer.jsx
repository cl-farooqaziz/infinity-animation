            ...
            <div className="px-5 lg:max-w-7xl mx-auto">
                <div className="flex gap-x-5 pb-8 flex-wrap lg:flex-nowrap justify-between gap-y-5 lg:gap-y-0">
                    <div className="basis-full sm:basis-[55%] pr-[55px] lg:basis-[30%]">
                        <Link href="/">
                            <Image src={logo} className="w-[50%] pb-3" alt="Infinity Animation" />
                        </Link>
                        <p className="text-[16px] poppins text-justify text-black mt-3 pr-5 pb-10">Our animation company the customers and delivering products that exceed expectations. </p>
                                    ...
                                    return (
                                        <li key={i} className="">
                                            <Link href={e.link} target="_blank">
                                                <Image src={e.icon} className="w-[20px] brightness-0 " alt="Infinity Animation" />
                                            </Link>
                                        </li>
                                    );
                                })
