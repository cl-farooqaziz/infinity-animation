                    ...
                    <div className="grid grid-cols-12">
                        ...
                        {isBranImage ?
                            <div className="col-span-5">
                                <div className="img absolute top-[-43px] right-[-15px] lg:top-[-110px] lg:right-[57px] md:block hidden">
                                    <Image src={branImage} alt='brandShine' height={622} width={389} className=' lg:min-h-[550px] xl:w-10/12' quality={85} />
                                </div>
                            </div> :
