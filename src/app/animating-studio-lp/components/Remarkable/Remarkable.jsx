                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-12 gap-5">
                        <div className="col-span-12 mb-5">
                            <h2 className='text-[55px] font-bold font-sans text-center text-black mb-3'>How We Achieve Remarkable Outcomes</h2>
                            <p className='text-[16px] leading-[21px] font-sans text-center text-black lg:w-10/12 mx-auto mb-10'>At Animating Studio, our meticulous work process is intricately crafted to yield flawless outcomes, whether for large-scale endeavors or smaller projects. Every detail is considered in our comprehensive approach to ensure excellence in every animation project.</p>
                        </div>
                        ...
                        <div className="col-span-5">
                            <div className="card bg-[#0E80FC] rounded-[15px] px-7 py-10 relative h-full">
                                <h4 className='text-[25px] font-bold font-sans text-white leading-[60px]'>Texturing</h4>
                        ...
                        <div className="col-span-5">
                            <div className="card bg-gradient-to-t from-[#09B7E4] to-[#19EDDA] rounded-[15px] px-7 py-10 relative h-full">
                                <h4 className='text-[25px] font-bold font-sans text-white leading-[60px]'>Rigging</h4>
                                ...
                                <Image src={Remark3} alt='remark' className='w-full h-[65%] object-contain absolute left-[-65px]' />
                            </div>
                        </div>
                        <div className="col-span-7">
                            <div className="card bg-gradient-to-t from-[#AA00FE] to-[#6B00FE] rounded-[15px] px-7 py-10 h-full relative">
                                <h4 className='text-[25px] font-bold font-sans text-white leading-[60px]'>Lightings</h4>
                                ...
                                <Image src={Remark4} alt='remark' className='w-full h-full object-contain mt-[-34px] mx-auto' />
                            </div>
                        </div>
                        <div className="col-span-7">
                            <div className="card bg-[#F4F4F4] rounded-[15px] px-7 py-10 h-full">
                        ...
                        <div className="col-span-5">
                            <div className="card bg-gradient-to-t from-[#FFAB4A] to-[#FF8E0A] rounded-[15px] px-7 py-10 relative h-full">
                                <h4 className='text-[25px] font-bold font-sans text-white leading-[60px]'>Compositing and Special VFX</h4>
                                ...
                                <Image src={Remark6} alt='remark' className='w-full absolute right-[-25px] max-h-[350px] min-w-[585px]' />
                            </div>
                        </div>
                        <div className="col-span-4">
                            <div className="card bg-gradient-to-t from-[#AA00FE] to-[#6B00FE] rounded-[15px] px-7 py-10 relative h-full min-h-[620px]">
                                <h4 className='text-[25px] font-bold font-sans text-white leading-[60px]'>Music and Foley</h4>
                        ...
                        <div className="col-span-4">
                            <div className="card bg-gradient-to-t from-[#0E80FC] to-[#058EF8] rounded-[15px] px-7 py-10 relative h-full min-h-[620px]">
                                <h4 className='text-[25px] font-bold font-sans text-white leading-[60px]'>Editing and Final Output</h4>
                        ...
                        <div className="col-span-4">
                            <div className="card bg-gradient-to-t from-[#FF2D4B] to-[#F71017] rounded-[15px] px-7 py-10 relative h-full min-h-[620px]">
                                <h4 className='text-[25px] font-bold font-sans text-white leading-[60px]'>Rendering</h4>
