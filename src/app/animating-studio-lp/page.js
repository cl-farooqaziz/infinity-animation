...
const page = () => {
  ...
  // ==== brands Start
  const brands = {
    title: "Ready to Make Your Brand Shine?",
    subtitle: "Ready to Make Your Brand Shine?",
    desc: "At Animating Studio, we epitomize professionalism through our animated videos, dedicatedly delivered to our esteemed clients. Our videos infuse vitality and intrigue into your subject matter. Our skilled animators specialize in transforming even the most intricate concepts into easily understandable visuals. At Animating Studio, we meticulously handle every aspect of your corporate identity, utilizing the latest and most relevant methods to enhance your brand in the market through our top-notch video services.",
    branImage: BranShine,
    isBranImage: true,
  }
